...
Ice.loadSlice("remotetypes.ice")  # Carga el archivo Slice que define los tipos de datos remotos
import RemoteTypes as rt  # Importa el módulo generado por Slice #type: ignore
